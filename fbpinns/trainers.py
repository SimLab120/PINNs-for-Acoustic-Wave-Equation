...
class FBPINNTrainer(_Trainer):
    ...
    def train(self):
        ...
        for i,active_ in enumerate(scheduler):
            ...
            if i%100==0:
                print("Iteration::",i," Loss value",lossval)
                loss_log.append(lossval)
        ...
        return all_params,loss_log,x_batch_test,model_fns
...
class PINNTrainer(_Trainer):
    ...
    def train(self):
        ...
        # cleanup
        writer.close()
        logger.info(f"[i: {i+1}/{self.c.n_steps}] Training completea")
